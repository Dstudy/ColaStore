...
"[project]/src/components/ThreeViewerHome.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/* 1. Import GSAP */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/gsap/index.js [app-client] (ecmascript) <locals>");
...
function ThreeViewerHome({ modelUrl }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeViewerHome.useEffect": ()=>{
            if (!mountRef.current) return;
            // Clear any existing canvas elements to prevent duplicates (React Strict Mode issue)
            while(mountRef.current.firstChild){
                mountRef.current.removeChild(mountRef.current.firstChild);
            }
            /* Scene Setup (Giữ nguyên) */ const scene = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"]();
            ...
            const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](45, mountRef.current.clientWidth / mountRef.current.clientHeight, 0.1, 100);
            ...
            scene.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AmbientLight"](0xffffff, 1.2));
            ...
            scene.add(dirLight);
            /* Controls */ const controls = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$OrbitControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OrbitControls"](camera, renderer.domElement);
            controls.enableZoom = false;
            controls.enablePan = false;
            controls.autoRotate = false;
            controls.enabled = false;
            /* Load GLTF & GSAP Animation */ const loader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$loaders$2f$GLTFLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GLTFLoader"]();
            let loadedModel = null;
            // Biến lưu trữ animation để dọn dẹp (cleanup) sau này
            let scrollTween = null;
            loader.load(modelUrl, {
                "ThreeViewerHome.useEffect": (gltf)=>{
                    loadedModel = gltf.scene;
                    // Auto-scale (Giữ nguyên)
                    const box = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box3"]().setFromObject(loadedModel);
                    ...
                    scrollTween = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(loadedModel.rotation, {
                        y: Math.PI * 6,
                        ease: "none",
                        scrollTrigger: {
            ...
            }["ThreeViewerHome.useEffect"], undefined, {
                "ThreeViewerHome.useEffect": (error)=>setError("Error: " + error.message)
            }["ThreeViewerHome.useEffect"]);
            /* Raycasting (Giữ nguyên từ bước trước) */ const raycaster = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Raycaster"]();
            ...
            const onPointerDown = {
                "ThreeViewerHome.useEffect.onPointerDown": (event)=>{
            ...
            }["ThreeViewerHome.useEffect.onPointerDown"];
            renderer.domElement.addEventListener("pointerdown", onPointerDown, {
                capture: true
            });
            /* Animation Loop */ const animate = {
                "ThreeViewerHome.useEffect.animate": ()=>{
            ...
            /* Resize */ const onResize = {
                "ThreeViewerHome.useEffect.onResize": ()=>{
                    if (!mountRef.current) return;
...
_s(ThreeViewerHome, "zy9HJP5+uJSpqWpdmevplh7F0eI=");
_c = ThreeViewerHome;
var _c;
__turbopack_context__.k.register(_c, "ThreeViewerHome");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gsap/ScrollTrigger.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ThreeViewerHome$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ThreeViewerHome.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
                ...
                "Home.useEffect": ()=>{
                    ...
                    if (modelRef.current) {
                        modelRef.current.traverse({
                            "Home.useEffect": (child)=>{
                                if (child.geometry) child.geometry.dispose();
                                if (child.material) {
                                    if (Array.isArray(child.material)) {
                                        child.material.forEach({
                                            "Home.useEffect": (mat)=>mat.dispose()
                                        }["Home.useEffect"]);
                                    } else {
        ...
        "Home.useEffect": ()=>{
            ...
            const setupScrollTween = {
                "Home.useEffect.setupScrollTween": ()=>{
                    ...
                    const sections = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray(".container-product .panel");
            ...
            const setupModelAnimations = {
                "Home.useEffect.setupModelAnimations": ()=>{
                    ...
                    if (modelRef.current) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(modelRef.current.scale, {
                            x: 0,
                            y: 0,
                            z: 0,
                            ease: "power2.out",
        ...
        "Home.useEffect": ()=>{
            ...
            const setupScrollTween = {
                "Home.useEffect.setupScrollTween": ()=>{
                    ...
                    const sections = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray(".container-feature .panel");
                    // Check if container and sections exist
                    if (!container || sections.length === 0) {
                        console.warn("Container or sections not found for scrollTween, retrying...");
                        // Retry after a short delay
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ThreeViewerHome$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(Home, "nwSc/Jv8DeZdTZyoN4Ti7m/aulM=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_2f492a1a._.js.map