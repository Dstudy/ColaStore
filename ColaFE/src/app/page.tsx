          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button className="mt-4 w-full bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 py-2 px-4 rounded-md hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors duration-200 font-medium">
                  Add to Cart
                </button>
              </div>
            </div>
