...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!fullname || !email || !password) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Full name, email and password are required");
            return;
        }
        setLoading(true);
        try {
            ...
            if (!res.ok || data.errCode !== 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.message || "Registration failed");
                setLoading(false);
                return;
            }
